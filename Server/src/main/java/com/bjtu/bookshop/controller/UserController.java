...
public class UserController {
    ...
    public LoginResponse userLogin(@Valid LoginRequest req, BindingResult br) {
        if (br.hasErrors()) return new LoginResponse() {{
            setState(-1);
        }};
    ...
    public LogoutResponse userLogout(@Valid LogoutRequest req, BindingResult br) {
        if (br.hasErrors()) return new LogoutResponse() {{
            setState(-1);
        }};
        if (!userService.checkUserToken(req)) return new LogoutResponse() {{
            setState(-10);
        }};
    ...
    public RegisterResponse userRegister(@Valid RegisterRequest req, BindingResult br) {
        if (br.hasErrors()) return new RegisterResponse() {{
            setState(-1);
        }};
    ...
    public PhoneResponse userPhone(@Valid PhoneRequest req, BindingResult br) {
        if (br.hasErrors()) return new PhoneResponse() {{
            setState(-1);
        }};
    ...
    public SetInfoResponse updateUserInfo(@Valid SetInfoRequest req, BindingResult br) {
        if (br.hasErrors()) return new SetInfoResponse() {{
            setState(-1);
        }};
        if (!req.trans()) return new SetInfoResponse() {{
            setState(-1);
        }};
        if (!userService.checkUserToken(req)) return new SetInfoResponse() {{
            setState(-10);
        }};
    ...
    public ManageSearchResponse searchUser(@Valid ManageSearchRequest req, BindingResult br) {
        if (br.hasErrors()) return new ManageSearchResponse() {{
            setState(-1);
        }};
        if (!userService.checkUserToken(req)) return new ManageSearchResponse() {{
            setState(-10);
        }};
        if (!userService.checkUserRole(req.getUid(), 1)) return new ManageSearchResponse() {{
            setState(-10);
        }};
    ...
    public ManageGetResponse getUserInfoM(@Valid ManageGetRequest req, BindingResult br) {
        if (br.hasErrors()) return new ManageGetResponse() {{
            setState(-1);
        }};
        if (!userService.checkUserToken(req)) return new ManageGetResponse() {{
            setState(-10);
        }};
        if (!userService.checkUserRole(req.getUid(), 1)) return new ManageGetResponse() {{
            setState(-10);
        }};
    ...
    public ManageSetResponse modifyUserInfo(@Valid ManageSetRequest req, BindingResult br) {
        if (br.hasErrors()) return new ManageSetResponse() {{
            setState(-1);
        }};
        if (!userService.checkUserToken(req)) return new ManageSetResponse() {{
            setState(-10);
        }};
        if (!userService.checkUserRole(req.getUid(), 1)) return new ManageSetResponse() {{
            setState(-10);
        }};
    ...
    public ManageAddResponse addUser(@Valid ManageAddRequest req, BindingResult br) {
        if (br.hasErrors()) return new ManageAddResponse() {{
            setState(-1);
        }};
        if (!userService.checkUserToken(req)) return new ManageAddResponse() {{
            setState(-10);
        }};
        if (!userService.checkUserRole(req.getUid(), 1)) return new ManageAddResponse() {{
            setState(-10);
        }};
